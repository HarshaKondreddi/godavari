...
public class Position {
    ...
    public Position(String product, String exchange, Double sellValue, Double lastPrice, Double unrealised, Double buyPrice, Double sellPrice, Double m2m, String tradingSymbol, int netQuantity, int sellQuantity, Double realised, int buyQuantity, Double netValue, Double buyValue, Double multiplier, String instrumentToken, Double closePrice, Double pnl, int overnightQuantity, double buym2m, double sellm2m, double dayBuyQuantity, double daySellQuantity, double dayBuyPrice, double daySellPrice, double dayBuyValue, double daySellValue, double value, double averagePrice) {
        this.product = product;
        this.exchange = exchange;
        this.sellValue = sellValue;
        this.lastPrice = lastPrice;
